#ifndef RAY_BBOX_INTERSECTIONS_IMPROVED_METHOD_H
#define RAY_BBOX_INTERSECTIONS_IMPROVED_METHOD_H
...
bool intersect_improved_method(const BBox &bbox, const Ray &ray, float t0, float t1) {
...
#endif //RAY_BBOX_INTERSECTIONS_IMPROVED_METHOD_H
